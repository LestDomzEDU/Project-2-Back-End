...
import org.springframework.http.HttpStatus; import org.springframework.jdbc.core.JdbcTemplate;
import org.springframework.web.bind.annotation.*; import java.util.*;
@RestController @RequestMapping("/api/admin") @CrossOrigin(origins="*")
public class EventAdminController {
  private final JdbcTemplate jdbc; public EventAdminController(JdbcTemplate jdbc){this.jdbc=jdbc;}
  @PutMapping("/events/{id}/result") @ResponseStatus(HttpStatus.OK)
  public Map<String,Object> setResult(@PathVariable long id, @RequestParam String result){
    ...
    Map<String,Object> out=new HashMap<>(); out.put("eventId",id); out.put("result",r); out.put("betsWon",won); out.put("betsLost",lost); return out;
  }
}
