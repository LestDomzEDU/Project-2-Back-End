...
public class EventController {
  ...
  public List<Map<String,Object>> events() {
    // Match the schema used in New-bets: league, home_team, away_team, start_time
  ...
  public Map<String,Object> event(@PathVariable long id) {
    ...
    // Odds price works whether column is odds_decimal (JPA) or legacy `decimal` (MySQL keyword)
  ...
  public List<Map<String,Object>> odds(@PathVariable long id) {
    // ensure event exists (clearer 404)
    try {
